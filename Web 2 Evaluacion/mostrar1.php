			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				...
				<table class="table table-striped table-dark">
					...
					<tbody>
						...
						$sql = "SELECT * FROM equips ORDER BY nom ASC";
						...
						while($row = $result->fetch_assoc()) {
							if($row["web"]==null){
								$web="No hay web disponible";
							}else{
								$web='<a href="'.$row["web"].'">'.$row["web"].'</a>';
							}
							if($row["escut"]==null){
								$escudo="No hay escudo disponible";
							}else{
								$escudo='<img width="30px" src="'.$row["escut"].'">';
							}
						echo '
							<tr>
